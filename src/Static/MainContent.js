function MainContent() {
    return (
        < div className="content">
            ...
            <p>I am a <b>Technical Architect</b> with 16+ years of experience on 20+ enterprise-grade software projects
                from various functional domains including HealthCare, Financial Services, Logistics, Banking, etc...</p>

            <h1 style={{ color: "Grey" }}>What I'm Doing</h1>

            <p> Presales, Architect, Solution, Design, Develop, Maintain, Mentor, Ownership, Lead, Talent Acquisition</p>
            ...
            <h1 style={{ color: "Grey" }}>On Azure</h1>

            <p> Active Directory Services, Power BI, Share point </p>
